    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <button onClick={() => setTab('cable')}
          className={`px-4 py-2 rounded font-semibold text-sm transition ${tab==='cable' ? 'bg-[#0EA5E9] text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}>
          케이블 ({cableKeys.length})
        </button>
        <button onClick={() => setTab('housing')}
          className={`px-4 py-2 rounded font-semibold text-sm transition ${tab==='housing' ? 'bg-[#0EA5E9] text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}>
                  ...
                  <tr key={key} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    ...
                    <td className="px-2 py-1">
                      <input type="number" min="0"
                        ...
                        className="w-28 border rounded px-2 py-0.5 text-right text-sm focus:outline-sky-400"
                      />
                    </td>
                  </tr>
                )
                  ...
                  <tr key={key} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    ...
                    <td className="px-2 py-1">
                      <input type="number" min="0"
                        ...
                        className="w-24 border rounded px-2 py-0.5 text-right text-sm focus:outline-sky-400"
                      />
                    </td>
                    <td className="px-2 py-1">
                      <input type="number" min="0"
